...
<!-- hero -->
<?php if(!is_home() && !is_single() && !is_404() && !is_category() && !is_author() && !is_search() && !is_page_template('search.php') && !is_page_template('template-theFirm.php') && !is_page_template('template-douglas.php') && !is_page_template('template-thankyou.php') && !is_page_template('template-contactus.php') && !is_page_template('template-privacy.php')): ?>
